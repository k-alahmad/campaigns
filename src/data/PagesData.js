...
//------ luxury appartments   --------
import pageFiveProjectOneHeader from "../assets/images/330riverside.webp";
import pageFiveProjectTwoHeader from "../assets/images/elingtton.webp";
...
export const LandingPages = [
		...
		projects: [
			{
				...
				HeaderTitle: {
					en: "Modern Villas Seamlessly Blended with Nature At Park Greens",
					ar: " فلل فخمة تمتزج مع الطبيعة بسلاسة في بارك غرين ",
				},
	...
	},
	{
		...
		PageName: { en: "Appartments", ar: "شقق فخمة" },
		slug: "appartments",
		projects: [
			{
				id: 0,
				slug: "330riverside",
				ProjectName: { en: "330 Riverside", ar: "مشروع 330" },
				HeaderTitle: {
					en: "Specially Designed Residence",
					ar: "مساكن تخاطب الروح",
				},
				HeaderTitleTow: {
					en: "Greenary",
					ar: "فلل فاخرة جدا من تلال الغاف",
				},
				HeaderImage: pageFiveProjectOneHeader,
				InfoTitle: {
					en: "A Spectacular Sight That Delights",
					ar: "مناظر خلاّبة تأسر القلوب",
				},
				InfoSubTitle: {
					en: "Designed Like A Tapered Crescent, Catch The Reflected Hues Of The Cluster, Dazzle In The Reflections Of The Crystal-Clear Water As You Unwind In Luxury",
					ar: "تم تصميم المجمّع على شكل هلال مدبّب و ينعكس تصميمه الرائع بأبهى حلّة على المياه المتلألئة, حيث يمكنك أن تمتّع ناظريك بأروع الإطلالات بينما تستمع بإقامة في مسكن ينضح فخامة.",
				},
				InfoData: [
					{
						Icon: coinIcon,
						Title: { en: "AED1.2M", ar: "AED1.2M" },
						SubTitle: { en: "Starting Price", ar: "بأسعار تبدأ من" },
					},
					{
						Icon: locationIcon,
						Title: { en: "MBR City", ar: "مدينة محمد بن راشد" },
						SubTitle: { en: "Location", ar: "الموقع" },
					},
					{
						Icon: percentage,
